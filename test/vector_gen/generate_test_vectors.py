...
def test_gen_vector_gravnet_core(recorder):
    coords = tf.random.normal(shape=(gravnet_config.B, gravnet_config.V, gravnet_config.S), stddev=0)
    feats = tf.random.normal(shape=(gravnet_config.B, gravnet_config.V, gravnet_config.F), stddev=20)
