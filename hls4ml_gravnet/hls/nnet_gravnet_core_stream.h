...
#pragma HLS UNROLL
            ...
            bitonic_sort_array_stream<CONFIG_T::n_neighbours, knn_dist_T, knn_idx_T>(current_best_d, current_best_i);
...
#pragma HLS UNROLL
                ...
                bitonic_sort_array_stream<CONFIG_T::n_neighbours, knn_dist_T, knn_idx_T>(next_d, next_i);

                nnet::array<knn_dist_T, CONFIG_T::n_neighbours> merged_d;
                nnet::array<knn_idx_T, CONFIG_T::n_neighbours> merged_i;

                merge_and_keep_k_stream<CONFIG_T::n_neighbours, knn_dist_T, knn_idx_T>(current_best_d, current_best_i,
                                                                                       next_d, next_i, merged_d, merged_i);

                current_best_d = merged_d;
                current_best_i = merged_i;
            }

            // 3. Output result for this pack
...
#pragma HLS PIPELINE II = 1
        ...
        output_T out_pack; // Accumulate the entire pack output here
